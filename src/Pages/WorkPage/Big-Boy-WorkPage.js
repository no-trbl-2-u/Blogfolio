...
//     const createBillboardText = (text, size = 0.3, color = 0x1e293b) => {
...
//     const backText = createBillboardText('BACK', 0.4, 0x1e293b);
...
//     spheresRef.current = workItems.map(createWorkSphere);
...
//           // Size scaling based on distance (depth illusion)
...
//     cursor: hoveredSphere || hoveredBack ? 'pointer' : 'default',
//     position: 'relative'
//   };
...
//       <h1 style={titleStyle}>WORK PORTFOLIO</h1>
//       <div ref={mountRef} />
